...
function jqAjaxPromise(param, progressFun = () => { }, origin = "web") {
  ...
  request_header['Request-Language'] = 'it';
...
const getinsurValue = () => {
  ...
  if (url == "/face-swap.html") {
    insurValue = "it_vidq_faceswap";
  } else if (url == "/video-translator.html") {
    insurValue = "it_vidq_videotranslate";
  } else if (url == "/") {
    // insurValue = "it_home";
  } else if (url == "/about.html") {
    // insurValue = "it_about";
  } else if (url == "/contact.html") {
    // insurValue = "it_contact";
  } else if (url == "/privacy.html") {
    insurValue = "it_privacy";
  } else if (url == "/terms.html") {
    insurValue = "it_terms";
  } else if (url == "/ai-attractiveness-test.html") {
    insurValue = "it_vidq_attracttest";
  }else if (url == "/multiple-face-swap.html") {
    insurValue = "it_vidq_mulfaceswap";
  }

  if (isSeo()) {
    insurValue = insurValue.replace("it", "itseo");
  }
  return insurValue;
};
    ...
    .then((res) => {
      ...
      if ((countryType === "T1" || countryType === "T2") && judgeClient() === 'ios' && document.location.pathname !== '/pricing.html') {
        ...
        $("#ios_footer_btn").click(function () {
          ...
          window.location.href = "https://apps.apple.com/app/apple-store/id6497986083?pt=127019031&ct=from_it_vidq&mt=8";
        });
      }
    }) 
    .catch((err) => {
