...
const getinsurValue = () => {
  ...
  if (url == "/face-swap.html") {
    insurValue = "pt_vidq_faceswap";
  } else if (url == "/video-translator.html") {
    insurValue = "pt_vidq_videotranslate";
  } else if (url == "/") {
    // insurValue = "pt_home";
  } else if (url == "/about.html") {
    // insurValue = "pt_about";
  } else if (url == "/contact.html") {
    // insurValue = "pt_contact";
  } else if (url == "/privacy.html") {
    insurValue = "pt_privacy";
  } else if (url == "/terms.html") {
    insurValue = "pt_terms";
  } else if (url == "/ai-attractiveness-test.html") {
    insurValue = "pt_vidq_attracttest";
  }else if (url == "/multiple-face-swap.html") {
    insurValue = "pt_vidq_mulfaceswap";
  }

  if (isSeo()) {
    insurValue = insurValue.replace("pt", "ptseo");
  }
  return insurValue;
};
...
$(function () {
  const productPage = ['/multiple-face-swap.html', '/face-swap.html', '/ai-girlfriend.html', '/ai-boyfriend.html']
  debugger;
    ...
    .then((res) => {
      ...
      if ((countryType === "T1" || countryType === "T2") && judgeClient() === 'ios' && document.location.pathname !== '/pricing.html') {
        ...
        $("#ios_footer_btn").click(function () {
          gtag("event", "pt_faceappclick_fcios");
          window.location.href = "https://apps.apple.com/app/apple-store/id6497986083?pt=127019031&ct=from_pt_vidq&mt=8";
        });
      }
    }) 
    .catch((err) => {
