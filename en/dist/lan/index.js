module.exports = {
  ...
  "header-credit": {
    ...
    video_translate_span:
      "Credits can be used to swap faces for photos, videos and GIFs with AI Face Swap.",
  ...
  creditPayDialog: {
    ...
    discount: "Discount",
    info_des:
      "Renewal on <span id='cur_date'></span>, at <span id='next_price'></span> every <span id='sub_date'></span>.",
    ...
    suc_des1:
      "Thank you for subscribing to Vidqu Credit! Your order for the <span class='product_info' id='suc_product_info'></span> is now complete. Your account (<span class='user_email' id='suc_user_email'></span>) will receive <span id='suc_product_credit'></span> credits automatically.",
    suc_des2:
      "If you don’t see the credits, try logging out and back in. For any questions, feel free to contact our <a href='https://www.vidqu.ai/contact.html' target='_blank'>Support Team</a>",
    btn_ok: "OK",
    fail_tip: "Payment Failed",
    fail_p:
      "Your payment was not successfully processed.<span></span> Please try again, or use a different payment method.",
    fail_try: "Try Again",
    fail_help: "Need help?",
    ...
    javascript: {
      ...
      suc_des1:
        "Thank you for subscribing to Vidqu Credit! Your order for the <span class='product_info' id='suc_product_info'></span> is now complete. Your account (<span class='user_email' id='suc_user_email'></span>) will receive <span id='suc_product_credit'></span> credits automatically.",
      suc_des3:
        "Thank you for choosing Vidqu Credit Pack! Your order for the Credit Pack (<span class='product_info' id='suc_product_info'></span>) is now complete. Your account (<span class='user_email' id='suc_user_email'></span>) will receive <span id='suc_product_credit'></span> credits automatically.",
      tip_fail: "Failed",
  ...
  noFondPage: {
    ...
    text2:
      "You can return to the <a href='/?ref=from404'>home page</a> for more information.",
  },
  home: {
    title: "Free AI Video Maker - Create Videos Fast on Vidqu AI",
    description:
      "Vidqu is a leading free AI video creation platform online. Use the AI video maker to create quality videos at no cost. No wait and get results in minutes!",
    textA: "All-in-One Free AI Video Maker",
    textAs: "Vidqu",
    textB:
      "Meet the best free online AI video maker. Start your easy, fast, and cost-free AI video creation journey!",
    textC: "Free Face Swap",
    textD: "Swap Face Now",
    textE: "Vidnod AI Face Swapper",
    textF:
      "Powered by state-of-the-art AI technology, Vidnod AI Face Swapper enables you to replace faces in photos and videos seamlessly. Upload the base photo or video and the target face, click the face-swap button, and see the magic happen in a second!",
  ...
  about: {
    ...
    description:
      "Vidqu is an online AI video maker that enables you to create videos for free in minutes. It is easy and perfect for your different video creation purposes.",
    textA: "About ",
    textD: "Vidqu",
    textB: "Welcome to Vidqu!",
    textC:
      "Vidqu provides an inclusive and accessible space for everyone to leverage the capabilities of AI in the realm of video creation. There is a diversity of AI tools and options to create, edit, and enhance video content. Embark on your AI-powered video creation journey with Vidqu!",
  },

  faceSwap: {
    title: "Face Swap AI Online Free for Photos & Videos - Vidqu AI",
    description:
      "Swap faces for photos & videos by Vidqu AI Face Swapper. Naturally face swap for photos, GIFs, and videos. Try this face swap AI now! Fast and 100% free.",
    ...
    faceSwapPop: {
      ...
      Model_Maximum_span:
        "You’ve reached the maximum usage today (Up to {{val}} time per day). Please try again after 24 hours.",
      Model_Maximum_span_p:
        "You’ve reached the maximum usage today <span>(Up to {{val}} times per day).</span> Please try again after 24 hours.",
      Model_MaximumFile_span: "Only supported video files: Max {{val}} MB.",
      Model_Remove_Watermark_btn: "No Watermark",
      limit: "Only supported image formats: JPG, PNG, and WEBP",
      pornographyMsg:
        "The image you uploaded may not meet our policy requirement. Please change it and try again.",
      processImage: "An exception occurred... Please try again.",
      celebrity:
        "The target photo you uploaded may not meet our policy requirement. Please change it and try again.",
      NoFace: "No face detected.",
      manyFace: "Multiple faces detected.",
      onlyone: "Only one picture can be uploaded.",
      downloading: "Downloading",
      support_formats_v:
        "Only supported formats: GIF, M4V, MP4, MOV and WEBM .",
      support_formats_p: "Only supported image formats: JPG, PNG, and WEBP",
      face_small:
        "The facial area should not be too small (not less than 5% of the photo)",
      ...
      Model_not_credit_span:
        "Sorry, you need <span class='redSpan'>{{val}} Credit</span> to swap face.",
      share_title_v: "Share",
      share_title_centent: "Share the photo now!",
      share__text:
        "Vidqu - My face swap image is just generated by @Vidqu_Official Free Face Swapper. Check it out:",
      ...
      Model_Remove_Watermark_span:
        "The images to be generated will be watermarked. Please select type of watermarks.",
      Model_Remove_Watermark_btn: "No Watermark",
      Model_Remove_Watermark_btn1: "Stock Watermark",
      Model_MaximumFile_title: "Maximum Limit Exceeded.",
      Model_MaximumFile_span:
        "Only supports max <span class='redSpan weightSpan'>{{val}} MB</span> video files for free. Please unlock more with credits.",
      ...
      Model_not_credit_span:
        "Sorry, you need <span class='redSpan weightSpan'>{{val}} Credit</span> to swap face.",
      Model_not_credit_span_p:
        "Sorry, you need <span class='redSpan weightSpan'>{{val}} Credits</span> to swap face.",
      Model_not_credits_btn: "Get More Credits",
      Analyzing_setp: "Analyzing",
      Swapping_step: "Swapping",
      estimated_wait_time:
        "<span>{{val}}</span> people ahead, estimated wait time <span>{{val2}}</span> {{val3}}.",
      wait_minutes: "minutes",
      wait_seconds: "seconds",
      Credits_failed:
        "An exception occurred... Credits will not consume, please try again.",
      Credits_failed_no_face:
        "No face detected. Credits will not consume, please change it and try again.",
      Credits_failed_multi_face:
        "Multiple faces detected. Credits will not consume, please change it and try again.",
      Credits_failed_nsfw:
        "The image you uploaded may not meet our policy requirement. Credits will not consume, please change it and try again.",
      Credits_failed_celebrity:
        "The target photo you uploaded may not meet our policy requirement. Credits will not consume, please change it and try again.",
    },
    faceSwapPop01: {
      ...
      exceedTitle: "Maximum Limit Exceeded.",
      exceed5:
        "You've reached the maximum usage today (Up to 5 times per day). Please unlock with credits.",
      exceed3:
        "You've reached the maximum usage today (Up to 3 times per day). Please unlock with credits.",
      limit: "Only supported image formats: JPG, PNG, and WEBP",
      ...
      Credits_failed_celebrity:
        "The target photo you uploaded may not meet our policy requirement. Credits will not consume, please change it and try again.",
      pornographyMsg:
        " Detected that the photo you uploaded may contain nudity or pornographic content. Please change the photo and try again.",
      processImage: "An exception occurred... Please try again.",
      NoFace: "No face detected.",
      manyFace: "Multiple faces detected",
      ...
      swapping: "Generating",
      step3_btn:
        "Swap Face Now <img src='/dist/img/face-swap/icon_arrow.svg' style='margin-left: 16px;'>",
      onlyone: "Only one file can be uploaded.",
      share__text:
        "MioCreate My AI face swap photo is just generated by @MioCreate_Official Online Face Swap for free. Just like this：",
      share__Tile: "Share",
      copied: "Copied successfully",
      share__box__text: "Share the photo with anyone you like!",
      v_up_maximum:
        "You've reached the maximum usage today (Up to {{val}} times per day). Please unlock with credits.",
      countryConfigtextRule: "Video: Max {{val}} MB",
      support_Max: "Only supported video files: Max {{val}} MB",
      T2_loadingText:
        "Your video has been successfully generated. Downloading…",
      click_here: "Please check “Downloads” on your browser.",
      support_formats_v:
        "Only supported formats: GIF, M4V, MP4, MOV and WEBM .",
      support_formats_p: "Only supported image formats: JPG, PNG, and WEBP",
      photo_small:
        "The resolution of the face in the photo is too low, your face swap may fail. Please change the photo and try again.",
      No_face: "No face detected.",
      Mutiple_face: "Multiple faces detected.",
      face_small:
        "The facial area should not be too small (not less than 5% of the photo)",
      ...
      mask_span_time:
        "The free face swapper only support the first {{val}}s of the video to be generated.",
      "Multi-face_swap_for_photos_and_videos":
        "Multi-face swap for photos and videos",
      ...
      upload_file_failed_credits:
        "File upload exception occurred. Credits will not consume, please change it and try again.",
      hq: "High quality",
      hqpoptitle: "High quality available",
      hqtips:
        "It is recommended to enable this feature for videos or photo above 1080p.",
      p1080p: "1080P",
      pop1080p:
        "Subscribe now to unlock your premium benefits for 1080p video and high quality photo.",
  ...
  faceSwapM: {
    ...
    multiDescription:
      "As an online free face swap AI, Vidqu AI Multiple Face Swap changes faces on group photos instantly. Fast, free, and seamless results.",
    multiH1: "Multiple Face Swap Online Free to Reface Group Photos",
    multiH1_p:
      "Changing two or more faces in group photos is such an easy thing that can be done in seconds. Upload your photos and start group photo face swap now!",
    ...
    text3:
      "Easily convert text to video with AI. Input your text, and an AI video will be generated with voice over and background music.",
    ...
    faceSwapPop01: {
      ...
      photos_or_mins_of_video:
        "Face swap <span>{{val}} photos</span> or <span>{{val2}} mins</span> of video",
      itemMob:
        "Face swap <span>{{val}} photos</span> or <span>{{val}} mins</span> of video",
      photos_num: "<span>{{val}} photos</span> to swap face",
      videos_mins: "Or <span>{{val}} mins</span> of videos to swap face",
      Video_not_exist: "Video dose not exist. Please generate a new one.",
      file_not_exist: "File dose not exist. Please upload a new one.",
    ...
    faceSwapPop02: {
      ...
      Model_not_credit_span:
        "Sorry, you need <span class='redSpan'>{{val}} Credit</span> to swap face.",
      Model_not_credit_span_p:
        "Sorry, you need <span class='redSpan'>{{val}} Credits</span> to swap face.",
      Model_not_credits_btn: "Get More Credits",
      Model_Maximum_title: "Maximum Limit Exceeded.",
      Model_Maximum_span:
        "You’ve reached the maximum usage today (Up to <span>{{val}} times</span> per day). Please unlock with credits. ",
      Model_Maximum_span_p:
        "You’ve reached the maximum usage today (Up to <span>{{val}} times</span> per day). Please unlock with credits.",
      Model_Maximum_btn: "Unlock with Credit",
      Model_MaximumFile_title: "Maximum Limit Exceeded.",
      Model_MaximumFile_span:
        "Only supports max <b>100 MB</b> video files for free. Please unlock more with credits.",
      Model_MaximumFile_span2: "Only supports max {{val}} MB video files.",
      OK: "OK",
      Model_MaximumFile_btn: "Unlock with Credit",
      Model_Remove_Watermark_title: "Remove Watermark?",
    ...
    faceSwapPop: {
      ...
      Model_MaximumFile_title: "Maximum Limit Exceeded.",
      Model_MaximumFile_span:
        "Only supports max <span class='redSpan weightSpan'>100 MB</span> video files for free. Please unlock more with credits.",
      Model_MaximumFile_btn: "Unlock with Credit",
      Model_not_credits_title: "Not Enough Credits.",
      Model_not_credit_span_p:
        "Sorry, you need <span class='redSpan weightSpan'>{{val}} Credits</span> to swap face.",
    ...
    share__text:
      "MioCreate Multi-face swap photo is generated by @MioCreate_Official Multiple Face Swap online free. It is like this:",
    ...
    exceed:
      " You’ve reached the maximum usage today <span>(Up to {{val}} times per day).</span> Please unlock with credits.",
    expired_file: "File does not exist. Please generate a new one.",
    NoFaceMulti: "No face detected.",
    downloading_multi:
      "Your file has been successfully generated. Downloading ...",
    downloadTips_multi:
      "You can <a href='javascript:;' class='click_multi_me' download>click here</a> to download this file again. Can’t find the downloaded file? Please check “Downloads” on your browser.",
  },
  ...
  contact: {
    ...
    conDescription:
      "Feel free to reach us whether you are seeking affiliate cooperation, want to be Vidqu reseller, or need to get help with our products. We're always here.",
    ...
    placeholder3:
      "Please describe the issue you are encountering. Minimum of 20 characters.",
    submit: "Submit",
  },
  privacy: {
    title: " Vidqu Privacy Policy",
    description:
      "Check out the Vidqu Privacy Policy and know about how Vidqu collects, uses, and shares user information in connection with its services and tools.",
    h1: "Privacy Policy",
    time: "Last Update: October 2024",
    text1:
      "This Privacy Policy applies to the websites (“https://www.vidqu.ai/”), its sub-websites, the software or applications (collectively, “Services”) owned and operated by Wise Reward Limited (“Vidqu AI”, “we”, “our” or “us”).",
    text2:
      "Vidqu AI respects your privacy and is strongly committed to keeping secure any information we obtain from you or about you. The purpose of this Privacy Policy is to inform you of what information we collect, use, and share when you visit our Websites and/or use our Products and Services. ",
    text3:
      "By visiting our Websites, by submitting your data to us, and by accessing, installing and/or using the Products and Services, please read this Privacy Policy carefully and ensure that you understand it.",
    text4:
      "Your acceptance of our Privacy Policy is deemed to occur upon your first use of our Site. If you disagree with this Privacy Policy, you must stop using our Site immediately.",
    text5:
      "All the information listed below that we collect is used for providing and improving the Services. We will not use or share your information with anyone except as described in this Privacy Policy. To maximize your privacy, Vidqu AI only collects the minimum information to provide a better user experience. ",
    ...
    text15:
      "<strong>Other information you choose to provide:</strong> We may interoperate with third parties to deliver seamless experience to you. Third parties may share some of your information with us, such as your name, email address, or other information needed to make the integration possible. Furthermore, if you register for or log in to our Services by using one of our single-sign-on providers (such as Google, LinkedIn, and Facebook), we collect the authentication data that the provider provides to us so that you may log in.",
    text16:
      "We use your personal information to provide you with the best possible products and services. Depending on the country in which you are located, we will only process your Personal Information based on a valid legal ground. ",
    text17:
      "We may use Personal Information for the following purposes:",
    text18:
      "To provide you with access to our Services, your Contact information, Account information and Technical data will be used;",
    text19:
      "To understand trends and preferences (analyze the Services), to improve and repair errors in the services, and to develop new products, services, features, and functionalities; analyzing your use of our Site and gathering feedback, we continually strive to improve our website offerings based on the information and feedback we receive from you. ",
    text20:
      "To personalize and tailorize our products and services for you, including surfacing recommendations, enabling you to create Output and generating such output for you. It is necessary to perform our obligations under the services agreement between you and us.",
    text21:
      "To communicate with you; including to send you information about our Services and events;",
    text22:
      "To prevent fraud, criminal activity, or misuses of our Services, and to protect the security of our systems, architecture, networks, and services;",
    ...
    text31:
      `Subscriber data will be deleted immediately upon clicking "Unsubscribe" at the bottom of any email sent from our company or upon manual request.`,
    text32:
      "Data security is of great importance to us, and to protect your data, we have put in place appropriate physical, electronic, and managerial procedures to safeguard and secure the data collected through our site.",
    text33:
      "Notwithstanding the security measures we take, it is important to remember that the transmission of data via the internet may not be completely secure and that you are advised to take suitable precautions when transmitting data via the Internet to us.",
    text34:
      "The policies and practices for sharing and/or disclosure of customer data to third parties is determined by the customer. Vidqu AI has no control over the customer's or any other third parties' choice to share and/or disclose customer data. Vidqu AI may share and disclose customer data in accordance with a Customer's instructions, including any applicable terms.",
    text35:
      "Vidqu AI does not share or disclose your personal information to any third parties with four exceptions as below:",
    ...
    text39:
      "<strong>During a change to Vidqu AI’s business.</strong> If Vidqu AI undertakes or is involved in any merger, acquisition, reorganisation, sale of assets, bankruptcy, or insolvency event, then we may sell, transfer, or share some or all of our assets, including your Personal Information, in connection with such transaction or in contemplation of such transaction, such as due diligence. ",
    text40:
      "Security is integral to Vidqu AI’s core principles of Control, Consent, and Collaboration and so we take it seriously. Vidqu AI has put in place suitable physical, electronic, and managerial procedures designed to safeguard and secure personal information collected through our Services (actually no method of transmission over the internet, or method of electronic storage is 100% secure). If you become aware of any potential data breach or security vulnerability, you are requested to contact us immediately. We will use all measures to investigate the incident, including preventive measures, as required.",
    text41:
      "In addition, it is extremely important that you understand that it is your responsibility to protect the security of your password for the account registered for Vidqu AI Services. The password should be strong and unique and not easy to be guessed. It should be known by you only. It is equally important that you keep a copy in a safe place for your own reference because you will need your password to decrypt all the data you saved in our Services. We are unable to decrypt your data.",
    text42:
      "Vidqu AI has an international corporate presence, and our collection of Personal Information involves the transmission of data on a global basis. Information we collect may be transferred to recipients outside of the EEA, Switzerland and the UK for the purposes described in this Privacy Policy. If you are based in the EEA, Switzerland or the UK and your Personal Data is transferred to a third country, that third country may not offer the same level of data protection as your home country. However, we transfer Personal Data pursuant to applicable data protection laws. To transfer your Personal Data outside of the EEA, Switzerland or the UK, we rely on the European Commission’s adequacy decisions on certain countries and, for other jurisdictions, we rely on the Standard Contractual Clauses as approved by the European Commission and any applicable country addenda. ",
    text43:
      "Cross-border transfers of Personal Information are carried out in accordance with the lawful bases outlined under applicable data protection laws, including the performance of a contract, the legitimate interests of Vidqu AI, or based on your explicit consent.",
    text44:
      "The collected Personal Information may be transferred to recipients outside the EU, where data protection laws may not provide the same level of protection. However, Vidqu AI ensures that all transfers are secured by appropriate safeguards and that your Personal Information is protected against unauthorized access, loss, or destruction, unlawful processing and any processing which is inconsistent with the purposes set out in this privacy policy.",
    text45:
      "Users maintain their rights to access, rectify, and erase their Personal Information, even when it is transferred internationally. If you wish to exercise any of these rights or require more information about our data transfer mechanisms, please contact us at support@vidqu.ai.",
    text46:
    ...
    text47:
      "When you submit information via our Services, you may be given options to process restrict use of your data in accordance with the principles of GDPR and especially having in mind your data protection rights, in particular your right, in certain circumstances, to:",
    text48:
      "Request access to any data held about you by Vidqu AI and information relating to how and why it is processed.",
    ...
    text52:
      "Ask to have inaccurate Personal Information rectified, or completed if it is incomplete.",
    text53:
      "Request the erasure of your Personal Information where data is no longer required for the original purpose or where you have withdrawn your consent, and no other lawful processing grounds apply.",
    text54:
      "Object to the processing of your Personal Information in certain circumstances.",
    text55:
      "Not to be subject to a decision based solely on automated processing, including profiling, which produces legal effects concerning you or similarly significantly affects you. You may exercise these rights by contacting us at support@vidqu.ai.",
  ...
  popupTip: {
    errorTitle: "Failed",
    errorTextA:
      "Email address is required. Please change a valid and try again.",
    errorTextB:
      "Name address is required. Please input your name and try again.",
    errorTextMessage:
      "Invalid message. 20–500 characters required. Please change a valid and try again.",
  ...
  login: {
    ...
    "your-vidnoz-ai-account-is-almost-ready":
      "Your Vidqu acccount is almost ready.",
    "you-might-need-to-check-your-spam-folder-if-you-dont-see-it-or":
      "You might need to check your spam folder if you don't see it. Or",
    "resend-confirmation-email": "Resend confirmation email",
    "reset-password": "Reset Password",
    "please-enter-your-email-address-and-well-sen":
      "Please enter your email address and we'll send you a link to get back into your Vidqu AI account.",
    ...
    "already-exists-in-Vidqu-ai-please-log-in-this":
      "already exists in Vidqu AI. Please log in this account to link",
    "log-in-and-link": "Log in and link",
    "you-are-almost-here": "You Are Almost Here!",
    "send-succ": "Sent successfully!",
    "send-succ-tip":
      "A link to reset your password has been sent to {{val}}.Please check your inbox.",
    ...
    "already-exists-in-vidnoz-ai-please-log-in-this":
      "already exists in Vidqu. Please log in this account to link",
    "enter-your-email-here": "Enter your email here",
    "hide-password": "Hide Password",
    "sign-up-failed-please-try-again-later":
      "Sign up failed. Please try again later.",
    "weve-sent-a-new-email-with-a-verification-link-to":
      "We've sent a new email with a verification code to",
    ...
    "registration-limit-exceeded-if-you-have-any-questions":
      "Registration limit exceeded. If you have any questions, please contact our online support.",
  ...
  loginUser: {
    ...
    pwd_tips: {
      ...
      description:
        "Sign into your Vidqu account and enjoy personalized service.",
  ...
  aiGirlFriend: {
    ...
    description: {
      name: "description",
      content:
        "AI girlfriend chatbot online free allowing you to send unlimited messages to AI characters and chat wildly.",
    },
    ...
    deleteRecentText:
      "The deletion of this conversation will be irreversible. All messages will be wiped out.",
    deleteMyChatTitle: "Delete this character",
    deleteMyChatText:
      "Are you sure you want to delete this character? All relevant information of it will be wiped out forever",
    Delete: "Delete",
    Cancel: "Cancel",
    Done: "Done",
    ...
    shareDes:
      "A stunning AI girlfriend chatbot online free allowing you to send unlimited messages to 30+ AI characters and chat wild.",
    errorTitle: "Failed",
  ...
  aiGirlFriendChat: {
    ...
    javascript: {
      ...
      loginContent:
        "Kindly log in to save the chat history for seamless roaming. You can resume these conversations at any time.",
      loginBtn: "Login",
      ...
      changePopRecommend:
        "The recommended image size is <span>3072 x 2048</span>",
      changePopBgBtn:
        "<span id='bgText'>Add new</span> <span>background</span>",
      changePopBgSupport: "Only JPG, PNG, and WEBP are supported",
      changePopCloseBtn: "Save",
      changePopOtherBtn:
        "<div class='login-popup-close-btn' id='changeOtherBtn'>Discard</div>",
  ...
  aiGirlFriendSeo: {
    section1: {
      ...
      text10:
        "This AI sexting simulator is set to offer different types of romances to all genders and sexes.",
      text11:
        "Private Pics, audio messages, AI girlfriend roleplay (coming soon)",
      text12:
        "We are adding more stunning features to this AI girlfriend chatbot",
    },
    section2: {
    ...
    section3: {
      ...
      text3: "Matilda",
      text4:
        "Vicky smiles warmly as she takes a seat next to you and offers you half of the brownie.",
      text5:
        "Well, if you keep saying things like that, we might have to find out eventually! But not today… Today we just want to enjoy some brownies together.",
      text6: "What can we do on this sweet night?",
    },
    section4: {
      h2: "Vidqu Spicy AI Girlfriends Fulfill Your Wishes and Lusts",
      text1:
        "<span>Step 1.</span> Choose an AI girlfriend from the front page gallery. ",
      text2:
        "<span>Step 2.</span> Send messages to her, and get wild responses from AI babes. ",
      text3:
        "<span>Step 3.</span> Unlock different topics and make this conversation go wild.",
    ...
    section5: {
      ...
      text2:
        "“You are the man I’ve been seeking, just gimme a hug and kiss me deep”",
    ...
    section6: {
      ...
      text7:
        "Best AI chats, response in the hottest way. Date with your AI soulmate and talk explicit content for free.",
      text8: "A: Free",
    ...
    section7: {
      ...
      text2:
        "Sexting AI girlfriend is a virtual chatbot character that you can talk dirty with.",
      text3: "Where can I find an unlimited and free AI girlfriend chatbot?",
      text4:
        "Many sites use filters to restrict users from talk explicit content with AI chatbot. But on this page, you can freely chat about any topic with our special AI GFs. ",
      text5: "AI girlfriend generator with exciting content?",
      text6:
        "This market charges money for extra services. You usually need to subscribe or buy credits to chat explicit content with your AI girlfriend. But on this page, you can enjoy all the services without costing a penny.",
      text7: " Can you customize your dream AI girlfriend?",
      text8:
        "You can set the figure, age, occupation, and personality of your AI GF. And define the relationship between you and her.",
      text9: "What if your AI girlfriend hated you?",
      text10:
        "Sometimes users are too rushed into erotic topics with their AI girlfriend but the mode is not set this way so users can get hated. Just restart your conversations and conquer her again.",
      text11: "Does AI girlfriend use you for data/AI training?",
      text12:
        "Vidqu promises you that it will never use your conversations for AI training. ",
      text13:
        "Best free AI sexting tool that offers virtual companion for adults?",
      text14:
        "Vidqu knows adults’ demands and builds targeted AI girlfriends to fulfill all their wishes. ",
  ...
  videoTranslate: {
    ...
    description: {
      name: "description",
      content:
        "Translate your videos into 140+ languages with Vidqu AI Video Translator. Enhance your global reach with this free video translator.",
    },
  ...
  aiToolPricing: {
    ...
    description: {
      name: "description",
      content:
        "Subscribe to Vidqu and unlock premium video translation with up to 65% off! Get credits and experience the power of Vidqu AI Video Translator!",
    },
    Credits: "Credits",
    ...
    Credit_FAQ_A1:
      "You can use credits to translate videos in <span>Vidqu AI Video Translator</span>. If the translation doesn't take place successfully, the credits will be refunded automatically.",
    Credit_FAQ_Q2: "Do my credits expire?",
    Credit_FAQ_A2:
      "While your subscription is active, your credits don't expire.",
    Credit_FAQ_Q3: "If I cancel my plan, will the remaining credits be lost?",
    Credit_FAQ_A3:
      "If you cancel, the remaining credits disappear at the end of the current subscription period, not immediately upon cancellation. For example, you purchase a monthly plan on November 1, 2023. If you cancel your subscription on November 2, 2023, the remaining credits will disappear on December 1, 2023.",
    Credit_FAQ_Q4:
      "Will unused credits be carried over to the next billing period?",
    Credit_FAQ_A4:
      "Yes, unused credits are accumulated and added to the new credits in the next billing cycle. For example, You purchase a monthly plan on November 1, 2023, and receive 80 credits. At the end of the current subscription period, there are 50 unused credits. For the next billing period, you will have a total of 130 credits (80 from the new subscription + 50 carried over from the previous period).",
    Credit_FAQ_Q5:
      "What distinguishes a monthly, half-yearly, and yearly subscription?",
    Credit_FAQ_A5:
      "The monthly subscription charges every month, the half-yearly subscription charges every six months, and the annual subscription charges once a year.",
    Credit_FAQ_Q6: "Does Vidnoz allow multiple face swaps at once?",
    Credit_FAQ_A6:
      "Yes, Vidnoz's face swap feature can handle multiple face swaps at once, enabling users to swap faces in group photos and videos with ease, for example.",
    "ai_face_swap": "AI Face Swap",
    ...
    javascript: {
      new_credits_p2:
        "• GIF & Video: Swapping 1 to 3 faces in a {{val}}-second video costs 5 credits. For 4 to 10 faces in a {{val}}-second video, the cost is calculated as the number of faces multiplied by 2 credits (e.g., 4 faces = 4 *2 = 8 credits).",
      "1_6faces": "1-6 Faces",
      ...
      Buy_Now: "Buy Now",
      m_your_plan1:
        "<span>{{val}} photos</span> or <span>{{val2}} mins</span> of videos to swap face",
      m_your_plan2: "No watermark on face-swapped photos",
      m_your_plan3: "Maximum video upload size <span>{{val}}MB</span>",
      m_your_plan4:
        "<span>{{val}} photo</span> swap<br/> or <span>{{val2}} mins</span> video swap",
  ...
  aiBoyFriend: {
    ...
    description: {
      name: "description",
      content:
        "100% free NSFW AI boyfriend online chatbot! Have intimate conversations with any virtual boyfriend of your type. No sign-up, no limit.",
    },
    faceSwap: "AI Face Swap",
    contact: "Contact Us",
    login: "Login",
    ...
    shareDes:
      "AI boyfriend online free chatbot for flirty and bold talks, with AI characters in various styles. Your AI boyfriend awaits there!",
    errorTitle: "Failed",
    errorDesc: "An exception occurred... Please try again.",
    errorNetwork: "Please check your network connection and try again",
    ok: "OK",
  ...
  aiAttractivenessTest: {
    ...
    description:
      "How attractive am I? Upload your photo on Vidqu AI Attractiveness Test, let this face rater analyze and deliver you a facial beauty test score from 1 to 100. ",
    ...
    banner2_p:
      "Create a stunning portrait by putting your face on another picture with better makeup. Test your new portrait and get a higher score. Try the online AI face swap for free!",
    ...
    swiper_11:
      "How to choose the best-looking among similar photos to upload on social media? You can choose the one that gets the highest score after AI photo rating.",
    swiper_2: "Choose the most attractive one as a profile picture",
    swiper_21:
      "Many platforms require uploading profile pictures, so there are many <a href='https://www.vidnoz.com/ai-solutions/profile-picture-maker.html'>profile picture makers</a>. Scroll up to the first screen, complete an attractiveness test, and select an impressive picture to upload as a profile picture.",
    swiper_3: "Advertise with the most appealing images",
    swiper_31:
      "Images used for advertising need to be carefully selected. If you don’t know which to choose, then use the AI attractiveness test to help you select. Generally, the higher the score, the better.",
    swiper_4: "Find distinctions when applying different makeup",
    swiper_41:
      "Different makeup is suitable for different people. Use AI face rating to test which makeup adds points to your appearance and which makeup detracts from it.",
    swiper_5: "Send appealing photos on dating apps or sites",
    swiper_51:
      "Which photo should you send to the man or woman you are attracted to to leave an unforgettable impression? AI attractiveness rater can distinguish beauty photos among them. Try it now and send appealing ones to your favorite person.",
    neck_1: "Image Upscaling",
    neck_2:
      "Picture clarity has a great impact on the results of the attractiveness test. Picture blur and distortion affect the AI's judgment of the position of the facial features, thus lowering the beauty score. Choose an <a href='https://www.vidnoz.com/ai-solutions/ai-image-upscaler.html'>AI-powered image upscaler </a> to improve picture clarity, increase resolution, and restore old photos with one click.",
    neck_3: "Face Retouch",
    neck_4:
      "What to do if you find obvious wrinkles, freckles, and acne on your face after taking pictures? Don’t worry. Face retouch tools use AI technology to remove wrinkles, eye bags, and other blemishes on your face with just one click, making your face look radiant again.",
    neck_5: "Face Thinner",
    neck_6:
      "A face that is too wide and a double chin affect your AI attractiveness test. Use <a href='https://www.vidnoz.com/ai-solutions/face-thinner-ai.html'>face thinner AI</a> to turn a square face into a V-shaped face and a double chin into a single chin by adjusting the face width, face shape, chin length, and width.",
    neck_7: "Change Hairstyle",
    neck_8:
      "Changing a hairstyle may change a person’s appearance. What kind of hairstyle is suitable for you? You can use an <a href='https://www.vidnoz.com/ai-solutions/hairstyle-changer.html'>online AI hairstyle changer</a> to find a hairstyle that suits you best, or use the <a href='https://www.vidnoz.com/face-swap.html'>face swap tool </a>to see how your face fits with a certain hairstyle.",
    neck_9: "Remove Glasses",
    neck_10:
      "Glasses block your beautiful eyes. Either take off the glasses when taking the photo, or use an <a href='https://www.vidnoz.com/ai-solutions/ai-photo-editor.html'>AI photo editor</a> to remove glasses from photos. At the same time, you can also use the tool to change your eye shape or eye color. Test different pictures with and without glasses.",
    neck_11: "Remove Beard",
    neck_12:
      "When you test two photos of the same face with and without beard, the attractiveness test results are also different. Beards will affect the shape of your face. Use no beard filter or beard remover to remove beards and improve the final appearance test results.",
    faqdesctitle: {
    ...
    faqdesctext: {
      index1:
        "Vidnoz AI Attractiveness Test uses advanced AI algorithms to analyze one's face attractiveness according to your uploaded photo and give a score from 1% to 100%. The higher the score, the more beautiful you are.",
      index2:
        "Yes. Vidnoz AI Attractiveness Test is a completely free online face beauty test tool. After the test is completed, you can also download the test result and save it offline.",
      index3:
        "AI attractiveness tester is just an AI-powered tool, and we cannot make sure its test result is 100% accurate. After all, the final test result is affected by many factors, such as photo clarity, facial contour, hairstyle, and more.",
      index4:
        "Generally, skin color doesn’t affect the score on AI attractiveness test. Our tool mainly analyzes your face according to the facial features.",
      index5:
        "Absolutely not. You are the only person who can see your uploaded photos. We don’t save your photos on our servers.",
    },
    ...
    more_2:
      "Make AI Attractiveness Test with Face Rating AI Tools: How Attractive Am I AI Free?",
    ...
    more_5:
      "How to Use AI Aging Filters to Visualize Your Look from Young to Old? 3 Ways Fixed!",
    more_6:
      "Top 5 Free AI Age Guessers: Find Out Anyone’s Age from Just 1 Photo",
    more_7:
      "Which Anime Character Do I Look Like in Photo? Check Your Own Animated Character Online",
    ...
    index_9:
      "Vidnoz AI Attractiveness Test is a comprehensive AI face rater that tests many aspects except for attractiveness. Learn more tests that can be completed with Vidnoz AI Attractiveness Test starting from how attractive am I test.",
    ...
    index_23:
      "Just as confidence and approachability can be adjusted through facial changes, the attractiveness can also be improved according to some slight changes on the face. Try the practical tips below to improve your beauty test score in no time.",
    index_24: "Test Your Facial Attractiveness for Free",
    index_25:
      "With Vidnoz AI Attractiveness Test, you can experience a free online AI attractiveness test to rate your face fast.",
    javascript: {
      Fun: "Fun",
      Smartness: "Smartness",
      ...
      exceedTitle: "Maximum Limit Exceeded.",
      exceed:
        "You've reached the maximum usage today (Up to <span>{{val}} times</span> per day). Please try again after 24 hours.",
      limit: "Only supported image formats: JPG, PNG, and WEBP",
      processImageTitle: "Failed",
      failed_des10: "File download exception occurred. Please try again.",
      pornographyMsg:
      ...
      onlyone: "Only one file can be uploaded",
      share__text:
        "Vidqu - I rate my face attractiveness online for free with AI Attractiveness Test by @Vidqu_Official. It is like this:",
      share__Tile: "Share",
      copied: "Copied successfully",
      share__box__text: "Share the image with anyone you like!",
      v_up_maximum:
        "You've reached the maximum usage today (Up to {{val}} times per day). Please try again after 24 hours.",
      countryConfigtextRule: "Video: Max {{val}} MB",
      support_Max: "Only supported video files: Max {{val}} MB",
      T2_loadingText:
        "Your video has been successfully generated. Downloading…",
      ...
      exception_occurred: "An exception occurred... Please try again.",
      share_text_v:
        "Vidnoz My AI face swap video is just generated by @Vidnoz_Official Face Swap for free. It is like this: ",
      share_title_v: "Share",
      share_title_centent: "Share the magic face swap video with your friends!",
      mask_span_time:
        "The free face swapper only support the first {{val}}s of the video to be generated.",
      ...
      evaluates: {
        ...
        Smartness4:
          "You're incredibly knowledgeable on a wide range of topics.",
        ...
        Approachability5:
          "You're the kind of person anyone would feel comfortable approaching.",
        Approachability6:
          "Your openness makes it easy for others to connect with you.",
        Approachability7: "You have a way of making people feel welcome.",
        Approachability8:
          "Your approachable attitude is a breath of fresh air.",
        Approachability9: "You're someone people naturally gravitate towards.",
        Approachability10:
          "Your down-to-earth personality makes you so approachable.",
  ...
  creditHistory: {
    ...
    confirm_p:
      "If you confirm, your remaining credits will all expire on <span class='dis_subtime'></span>. Please contact our <a href='/contact.html' target='_blank'>support team</a> if you need any help.",
    confirm_btn: "Confirm",
    no_confirm_btn: "Not Now",
    cancel_suc_title: "Subscription Cancellation Successful",
    cancel_suc_p:
      "Your subscription has been successfully canceled! You will no longer be billed, please reach out to our <a href='/contact.html' target='_blank'>support team</a> for any inquiries or assistance.",
    cancel_ok: "OK",
    cancel_fail_title: "Subscription Cancellation Failed",
    cancel_fail_text:
      "We apologize for the inconvenience. Please try again or contact our <a href='/contact.html' target='_blank'>support team</a> for further assistance in resolving this issue.",
