...
const getinsurValue = () => {
  ...
  if (url == "/ai-boyfriend.html") {
    insurValue = "en_vidq_aiboyfriend";
  }
...
$("body").on("mouseup", function (e) {
  ...
  if (isClickInformBtn) {
    ...
    gtag("event", "notifications_aiboyfriend_header");
...
$("#header_login").click(() => {
  gtag("event", "login_aiboyfriend_header");
});

$(".signoutBtn").click(() => {
  gtag("event", "signout_aiboyfriend_header");
});
