...
const getinsurValue = () => {
  ...
  if (url == "/face-swap.html") {
    insurValue = "en_vidq_faceswap";
  } else if (url == "/video-translator.html") {
    insurValue = "en_vidq_videotranslate";
  } else if (url == "/") {
    // insurValue = "en_home";
  } else if (url == "/about.html") {
    // insurValue = "en_about";
  } else if (url == "/contact.html") {
    // insurValue = "en_contact";
  } else if (url == "/privacy.html") {
    insurValue = "en_privacy";
  ...
  }else if (url == "/my-files.html") {
    insurValue = "en_vidq_myfiles";
  }
    ...
    .then((res) => {
      ...
      if ((countryType === "T1" || countryType === "T2") && judgeClient() === 'ios' && document.location.pathname !== '/pricing.html') {
        ...
        $("#ios_footer_btn").click(function () {
          ...
          window.location.href = "https://apps.apple.com/app/apple-store/id6497986083?pt=127019031&ct=from_en_vidq&mt=8";
        });
      }
    }) 
    .catch((err) => {
