...
class BottomMessage extends HTMLElement {
    constructor() {
        ...
        this.timer = null
        this.bottom = this.getAttribute('bottom') || '50px'
    }

    connectedCallback() {
        this.innerHTML = `<div  style="bottom: ${this.bottom}"  class="bottom-message-box bottom-message flex-item-center ${this.type === 'error' ? 'ero' : this.type === 'btnmsg' ? 'btn-msg' : this.type === 'avatar' ? 'avatar' : ''}">
