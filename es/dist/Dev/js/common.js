...
function jqAjaxPromise(param, progressFun = () => { }, origin = "web") {
  ...
  request_header['Request-Language'] = 'es';
...
const getinsurValue = () => {
  ...
  if (url == "/face-swap.html") {
    insurValue = "es_vidq_faceswap";
  } else if (url == "/video-translator.html") {
    insurValue = "es_vidq_videotranslate";
  } else if (url == "/") {
    // insurValue = "es_home";
  } else if (url == "/about.html") {
    // insurValue = "es_about";
  } else if (url == "/contact.html") {
    // insurValue = "es_contact";
  } else if (url == "/privacy.html") {
    insurValue = "es_privacy";
  } else if (url == "/terms.html") {
    insurValue = "es_terms";
  } else if (url == "/ai-attractiveness-test.html") {
    insurValue = "es_vidq_attracttest";
  }else if (url == "/multiple-face-swap.html") {
    insurValue = "es_vidq_mulfaceswap";
  }
...
$(function () {
  const productPage = ['/multiple-face-swap.html','/multiple-face-swap.html?openTab=videofs', '/face-swap.html','/face-swap.html?openTab=videofs', '/novia-virtual.html', '/ai-boyfriend.html']
